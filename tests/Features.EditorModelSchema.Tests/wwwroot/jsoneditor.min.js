...
(function () {
    ...
    JSONEditor.defaults.resolvers.unshift(function (schema) {
        // Type `array` with format set to `table`
        if (schema.format === "objecttabs") {
            return "objecttabs";
        }
    });

    JSONEditor.defaults.editors.objecttabs = JSONEditor.AbstractEditor.extend({
        getDefault: function () {
            return this.schema.default || [];
        },
        register: function () {
        ...
        getItemSchema: function (i) {
            return this.schema.properties[i];
        },
        getItemInfo: function (i) {
            var schema = this.getItemSchema(i);
        ...
        setValue: function (value, initial) {
            ...
            if (!new_active_tab && Object.keys(self.rows).length) new_active_tab = self.rows[Object.keys(self.rows)[0]].tab;
        ...
        refreshValue: function (force) {
            ...
            //// If we currently have minItems items in the array
            var minItems = this.schema.minItems && this.schema.minItems >= Object.keys(this.rows).length;
